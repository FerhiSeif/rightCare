...
export const RC_API_BASE_DOMAIN_LOCAL = 'localhost:3000';
...
export const RC_SOCKET_BASE_DOMAIN_LOCAL = 'localhost:3000';
...
export const sioTicketSetting = `ticket_setting_${uuid1()}`;
