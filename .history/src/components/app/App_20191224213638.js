...
class App extends Component {
  ...
  componentDidMount() {
    ...
    TicketSettingsHttpService.getDatasTicketSettings().then((response) => {
      ...
      TicketSettingsHttpService.onSocketGetTicketSettings(response).then((res) => {
        console.log(res);
      });

      console.log('onSocketGetTicketSettings : ', TicketSettingsHttpService.onSocketGetTicketSettings(response));
    });
    /* END $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ */
