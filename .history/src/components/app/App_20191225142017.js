...
const App = (props) => {
  ...
  const [stateApp, setStateApp] = useState({
    defaultLang: {
      label: i18n.language === 'en' ? enLabelIcon : frLabelIcon,
  ...
  */
  ...
  useEffect(() => {
    ...
    */
    ...
    console.log('updateWindowDimensions : ', stateApp.containerWidth);
    

    updateWindowDimensions();
    window.addEventListener('resize', stateApp.containerWidth);
    ...
    return () => {
      window.removeEventListener('resize', stateApp.containerWidth);
