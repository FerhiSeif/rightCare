...
export const SOCKET = {
  BASE_URL: APP_ENV === 'DEV' ? `${RC_SOCKET_BASE_DOMAIN_DEV}${RC_SOCKET_SERVICE_PATH}`
    : APP_ENV === 'PROD' ? `${RC_SOCKET_BASE_DOMAIN_PROD}${RC_SOCKET_SERVICE_PATH}`
      : APP_ENV === 'LOCAL' ? `${RC_SOCKET_BASE_DOMAIN_LOCAL}${RC_SOCKET_SERVICE_PATH}`
        : '',
};
